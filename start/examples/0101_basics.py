"""Basics: using the playground_start library.

What: demonstrates the two functions exported by playground_start —
...
from playground_start import fizzbuzz, slugify
